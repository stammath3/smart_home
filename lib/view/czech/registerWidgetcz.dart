...
import 'package:smarthomev_2/view/czech/registercz.dart';
    ...
    return Container(
      ...
      child: Column(children: [
        ...
        onChanged: (value) { setState(() { this.value = value;
          if(value=='Czech'){
            Navigator.push(context,MaterialPageRoute(builder: (context) => RegisterPagecz()));
          }
...
class RegisterText extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text('Vytvořte si účet Smart Home',
    style: TextStyle(fontSize: 24, color: Styles.textColor,fontWeight: FontWeight.bold));
  }
}
...
class TextRegisterT extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text('''Vaše údaje budeme ukládat v souladu se zákony a předpisy země nebo regionu, který si vyberete.  ''',
...
class ElavatedButtonR extends StatelessWidget {
  const ElavatedButtonR({
    Key? key,
    required GlobalKey<FormState> formkeyr, 
  }) : _formkeyr = formkeyr, super(key: key);

  final GlobalKey<FormState> _formkeyr;

  @override
  Widget build(BuildContext context) {
    return ElevatedButton(
      style: ElevatedButton.styleFrom(
      foregroundColor: Styles.whiteColor, backgroundColor: Styles.textColor, minimumSize: Size(310, 33)
      ),
      onPressed: (){
...
class TextA extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return Text('''Přečetl jsem a souhlasím s účtem SmartHome''');
  }
}
